...
-- CreateTable
CREATE TABLE "patient_halth_data" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "patient_halth_data_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "patient_halth_data_patientId_key" ON "patient_halth_data"("patientId");

-- AddForeignKey
ALTER TABLE "patient_halth_data" ADD CONSTRAINT "patient_halth_data_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "patients"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
